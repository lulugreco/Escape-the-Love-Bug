...
void goToStart() {
    fillScreen((((31) & 31) | ((20) & 31) << 5 | ((31) & 31) << 10));
    ...
    int spacing = 12;
    for(int i = 0; i < 8; i++){
        drawChar(col + (i * spacing), 70, letters[i], (((31) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10));
    }
    drawString(85, 50, "ESCAPE THE ", (((31) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10));

    drawRectangle(55, 40, 130, 3, (((31) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10));
    drawRectangle(55, 85, 130, 3, (((31) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10));
    drawRectangle(55, 40, 3, 45, (((31) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10));
    drawRectangle(182, 40, 3, 45, (((31) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10));
...
void goToPause() {
    ...
    drawString(70, 18, "You're Paused", (((31) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10));
    drawString(50, 40, "Press Start to Resume", (((31) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10));
    drawRectangle(100, 70, 10, 30, (((31) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10));
    drawRectangle(120, 70, 10, 30, (((31) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10));
    waitForVBlank();
    state = PAUSE;
}
...
void goToWin() {
    ...
    drawString(45, 120, "press start to play again!", (((31) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10));
    waitForVBlank();
    state = WIN;
}
...
void goToLose() {
    ...
    drawString(45, 90, "Wanna try again? Hit Start!", (((31) & 31) | ((31) & 31) << 5 | ((31) & 31) << 10));
    waitForVBlank();
    state = LOSE;
}
